...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.reservationconfirmpage.string.reservation_confirmation"
                 var="confirming_reservation"/>
    <fmt:message bundle="${loc}" key="local.reservationconfirmpage.string.reserving_room_description"
                 var="reserving_room_description"/>
    ...
    <fmt:message bundle="${loc}" key="local.reservationconfirmpage.string.user_who_reserving_room"
                 var="user_who_reserving_room"/>
    ...
    <fmt:message bundle="${loc}" key="local.reservationconfirmpage.button.confirm_reservation"
        ...
        <ul>
            <li style="text-align: center">
                ...
                <div class="cabinet_buttons">
                    <form action="mainController" name="post" class="cabinet_button">
                        <input type="hidden" name="command" value="reservation_confirm">
                        <input type="submit" value="${confirm_reservation}">
                    </form>
                    <form action="mainController" name="get" class="cabinet_button">
