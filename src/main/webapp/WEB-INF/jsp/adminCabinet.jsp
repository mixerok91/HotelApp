...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.admincabinetpage.button.administrating_room_types"
                 var="administrating_room_types"/>
    ...
    <fmt:message bundle="${loc}" key="local.admincabinetpage.string.found_reservations_in_period"
                 var="found_reservation_in_period"/>
...
<div class="main_content">
    ...
    <div class="horizontal_center">
        ...
        <div>
            <span>${requestScope.adminPageMessage}</span>
        </div>
        <ul>
