...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.roomadministrationpage.string.enter_quantity_of_persons"
                 var="enter_quantity_persons"/>
    <fmt:message bundle="${loc}" key="local.roomadministrationpage.string.enter_price_per_day"
                 var="enter_price_per_day"/>
    <fmt:message bundle="${loc}" key="local.roomadministrationpage.string.select_room_type" var="select_room_type"/>
    <fmt:message bundle="${loc}" key="local.roomadministrationpage.string.upload_room_picture"
                 var="upload_room_picture"/>
...
<div class="main_content">
    ...
    <div class="horizontal_center">
        ...
        <div>
            <ul>
                <h3>${create_new_room}</h3>
                <li>
                    <div>
                        <form action="mainController" method="post" enctype="multipart/form-data" class="center_form">
